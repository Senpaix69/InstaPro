      ...
      {session ? (
        <>
          <section className="col-span-2">
            <div hidden={!showNotification} className={`m-2 p-4 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-gray-900 dark:text-gray-300 transition-all duration-1000 ${timer ? "" : "-mt-[355px] -translate-y-full"}`}>
