...
const Chats = () => {
    ...
    return (
        <div className={`h-screen overflow-y-scroll scrollbar-hide ${darkMode ? "" : "dark bg-gray-900"}`}>
            <div className='flex flex-col justify-between max-w-6xl md:mx-5 lg:mx-auto'>
                <Header />
                <div className='bg-gray-100 flex justify-center dark:text-gray-200 dark:bg-gray-900'>
